...
public class TransNo {
        ...
        ResultSet hasilquery = null;
            ...
            try {
               ...
               // hasilquery = stm.executeQuery("SELECT * FROM  tbheaderpo where date_po = '2013-06-13'  order by trans_no desc limit 0,1");
                ...
                JOptionPane.showMessageDialog(null, " TransNo.java Error : 3ss111 Trans No : "+ ex, "Error ", JOptionPane.ERROR_MESSAGE);
                System.exit(1);
            }
     ...
     * dibutuhkan dcomposer dengan format tanggal-bulan-tahun
     */
